...
<text-box-wrapper>
    <text-box id="text-box-<?= $cId ?>" contenteditable><div>Text block 1</div><h3>Heading</h3><div>Text block 2<img-gallery gallery-id="1" aspect-ratio="4/3" width="320px" transition-time="1s" wait-time="3000ms"></img-gallery></div><p>Paragraph</p></text-box>
</text-box-wrapper>
